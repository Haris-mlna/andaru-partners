  ...
  return (
    <div className={styles.feed}>
      ...
      <div className={styles.commentpost}>
        ...
        />
        <ButtonPrimary new_className={styles.btnSendComment} text={<IconsFA new_className={styles.sendComment} title={'near_me'}/>} />
      </div>
      <div className={styles.resultComment}>
        <div className={styles.wrapResultComment}>
        <div className={styles.profilrAv}> <AvatarSidebar/></div>
        <div className={styles.firstComment}>
        <span>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dignissimos, temporibus inventore molestiae reiciendis non neque tenetur amet autem nisi pariatur voluptatum necessitatibus quis? Libero commodi consequuntur modi beatae architecto iusto, in nesciunt iure laudantium enim ex deserunt quibusdam voluptas delectus non natus ipsam voluptates eaque? Nulla fugit laudantium tenetur blanditiis!</span>
        </div>
        </div>
